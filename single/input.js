...
function initInput(){
	...
	tutorial_div = document.createElement("div");
	t = document.createTextNode("tutorial_div");
	tutorial_div.className = "tutorial_div";
	document.body.appendChild(tutorial_div);
	tutorial_div.style.display = 'block';
	//window.innerWidth
	tutorial_title = document.createElement("p");
	t = document.createTextNode("HELP");
	tutorial_title.className = "tutorial_title";
	tutorial_title.id = "tutorial_title";
	tutorial_title.appendChild(t);
	tutorial_div.appendChild(tutorial_title);

	tutorial_message = document.createElement("p");
	t = document.createTextNode("");
	tutorial_message.className = "tutorial_message";
	tutorial_message.appendChild(t);
	tutorial_div.appendChild(tutorial_message);

	tutorial_ok = document.createElement("BUTTON");
	t = document.createTextNode("OK");
	tutorial_ok.className = "tutorial_ok";
	tutorial_ok.appendChild(t);
	tutorial_ok.onclick = function(){TutorialSystem.ok();};
	tutorial_div.appendChild(tutorial_ok);
...
function clickObject(obj){
	...
	if(selectedPlanet === null && game_data.buildings[obj.unitID].owner === player_id){
		...
		//TutorialSystem.check([selectedPlanet.unitID,  targetPlanet.unitID]);
